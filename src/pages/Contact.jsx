				...
				<div className="col-md-6 d-flex align-items-center order-lg-1 order-md-2 flex-column py-5">
					<div className="row col-12">
						<div className="col-md-6">
							...
							<p className="small">
								We install and supply all your structured cabling, CCTV and IT solutions.<br/><br/>
								<span className="m-2 ml-0 hdrcolor"><CallOutlinedIcon /></span>+6395464546<br/><br/>
								<span className="m-2 ml-0 hdrcolor"><EmailOutlinedIcon /></span>sample@example.com<br/><br/>
								<span className="m-2 ml-0 hdrcolor"><LocationOnOutlinedIcon /></span>Manila, Philippines
							</p>

						</div>
						<div className="col-md-6">
							<span className="lead mb-3">Sales</span>
							<p className="small">Purchase our high quality products.<br/><br/>
								<span className="m-2 ml-0 hdrcolor"><CallOutlinedIcon /></span>+6395335546<br/><br/>
